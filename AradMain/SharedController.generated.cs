    ...
    public class SharedController
    {
        ...
        public class ViewsClass
        {
            ...
            public class _ViewNamesClass
            {
                ...
                public readonly string _LayoutBlog = "_LayoutBlog";
                public readonly string _LayoutGrid = "_LayoutGrid";
                public readonly string _Opengraph = "_Opengraph";
                public readonly string _SiteName = "_SiteName";
                public readonly string _ZoneAboutCompany = "_ZoneAboutCompany";
                public readonly string _ZoneBlogList = "_ZoneBlogList";
                public readonly string _ZoneContact = "_ZoneContact";
            ...
            public readonly string _LayoutBlog = "~/Views/Shared/_LayoutBlog.cshtml";
            public readonly string _LayoutGrid = "~/Views/Shared/_LayoutGrid.cshtml";
            public readonly string _Opengraph = "~/Views/Shared/_Opengraph.cshtml";
            public readonly string _SiteName = "~/Views/Shared/_SiteName.cshtml";
            public readonly string _ZoneAboutCompany = "~/Views/Shared/_ZoneAboutCompany.cshtml";
            public readonly string _ZoneBlogList = "~/Views/Shared/_ZoneBlogList.cshtml";
            public readonly string _ZoneContact = "~/Views/Shared/_ZoneContact.cshtml";
