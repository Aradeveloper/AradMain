...
namespace ControlPannel.Areas.Administration.Controllers
{
    public partial class RoleController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public RoleController Actions { get { return PaMVC.Administration.Role; } }
        ...
        public class ViewsClass
        {
            ...
            public readonly string _ListAjax = "~/Areas/Administration/Views/Role/_ListAjax.cshtml";
            public readonly string Create = "~/Areas/Administration/Views/Role/Create.cshtml";
            public readonly string Edit = "~/Areas/Administration/Views/Role/Edit.cshtml";
            public readonly string List = "~/Areas/Administration/Views/Role/List.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_RoleController : ControlPannel.Areas.Administration.Controllers.RoleController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, AradCms.Core.ViewModel.Role.AddRoleViewModel viewModel, int[] permissionIds);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Create(AradCms.Core.ViewModel.Role.AddRoleViewModel viewModel, int[] permissionIds)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, AradCms.Core.ViewModel.Role.EditRoleViewModel viewModel, int[] permissionIds);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Edit(AradCms.Core.ViewModel.Role.EditRoleViewModel viewModel, int[] permissionIds)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "viewModel", viewModel);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "permissionIds", permissionIds);
        ...
        [NonAction]
        partial void SetRoleForRegisterOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string id);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> SetRoleForRegister(string id)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.SetRoleForRegister);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "id", id);
        ...
        [NonAction]
        partial void RoleNameExistOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, string name, string id);

        [NonAction]
        public override System.Web.Mvc.JsonResult RoleNameExist(string name, string id)
        {
