...
namespace ControlPannel.Areas.Administration.Controllers
{
    public partial class UserController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public UserController Actions { get { return PaMVC.Administration.User; } }
        ...
        public class ViewsClass
        {
            ...
            public readonly string _ListAjax = "~/Areas/Administration/Views/User/_ListAjax.cshtml";
            public readonly string Create = "~/Areas/Administration/Views/User/Create.cshtml";
            public readonly string Edit = "~/Areas/Administration/Views/User/Edit.cshtml";
            public readonly string List = "~/Areas/Administration/Views/User/List.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_UserController : ControlPannel.Areas.Administration.Controllers.UserController
    {
        ...
        [NonAction]
        partial void ListAjaxOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, AradCms.Core.ViewModel.User.UserSearchViewModel search);

        [NonAction]
        public override System.Web.Mvc.ActionResult ListAjax(AradCms.Core.ViewModel.User.UserSearchViewModel search)
        {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, AradCms.Core.ViewModel.User.EditUserViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Edit(AradCms.Core.ViewModel.User.EditUserViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, AradCms.Core.ViewModel.User.AddUserViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Create(AradCms.Core.ViewModel.User.AddUserViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "viewModel", viewModel);
        ...
        [NonAction]
        partial void PhoneNumberExistOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, string phoneNumber, string id);

        [NonAction]
        public override System.Web.Mvc.JsonResult PhoneNumberExist(string phoneNumber, string id)
        {
        ...
        [NonAction]
        partial void GooglePlusIdExistOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, string googlePlusId, string id);

        [NonAction]
        public override System.Web.Mvc.JsonResult GooglePlusIdExist(string googlePlusId, string id)
        {
        ...
        [NonAction]
        partial void FaceBookIdExistOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, string faceBookId, string id);

        [NonAction]
        public override System.Web.Mvc.JsonResult FaceBookIdExist(string faceBookId, string id)
        {
