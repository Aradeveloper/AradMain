...
public static partial class SlMVC
{
    static readonly SlidersClass s_Sliders = new SlidersClass();
    public static SlidersClass Sliders { get { return s_Sliders; } }
}

namespace T4MVC
{
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class SlidersClass
    {
        public readonly string Name = "Sliders";
        public SliderPlugin.Areas.Sliders.Controllers.AdminSliderController AdminSlider = new SliderPlugin.Areas.Sliders.Controllers.T4MVC_AdminSliderController();
        public SliderPlugin.Areas.Sliders.Controllers.SliderWidgetController SliderWidget = new SliderPlugin.Areas.Sliders.Controllers.T4MVC_SliderWidgetController();
        public T4MVC.Sliders.SharedController Shared = new T4MVC.Sliders.SharedController();
    }
}
...
namespace SlLinks
{
    ...
    public static class Scripts {
        ...
        public static readonly string jquery_sider_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(UrlPath + "/jquery.sider.min.js") ? Url("jquery.sider.min.js") : Url("jquery.sider.js");
    ...
    public static partial class Bundles
    {
        public static partial class Scripts 
        {
            public static class Assets
            {
                ...
                public const string jquery_sider_js = "~/Scripts/jquery.sider.js"; 
