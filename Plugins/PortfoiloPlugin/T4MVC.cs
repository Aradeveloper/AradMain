...
public static partial class PoMVC
{
    static readonly PortfoiloClass s_Portfoilo = new PortfoiloClass();
    public static PortfoiloClass Portfoilo { get { return s_Portfoilo; } }
}

namespace T4MVC
{
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class PortfoiloClass
    {
        public readonly string Name = "Portfoilo";
        public PortfoiloPlugin.Areas.Portfoilo.Controllers.AdminCategoryController AdminCategory = new PortfoiloPlugin.Areas.Portfoilo.Controllers.T4MVC_AdminCategoryController();
        public PortfoiloPlugin.Areas.Portfoilo.Controllers.AdminPortfoiloController AdminPortfoilo = new PortfoiloPlugin.Areas.Portfoilo.Controllers.T4MVC_AdminPortfoiloController();
        public PortfoiloPlugin.Areas.Portfoilo.Controllers.WidgetController Widget = new PortfoiloPlugin.Areas.Portfoilo.Controllers.T4MVC_WidgetController();
        public T4MVC.Portfoilo.SharedController Shared = new T4MVC.Portfoilo.SharedController();
    }
}
