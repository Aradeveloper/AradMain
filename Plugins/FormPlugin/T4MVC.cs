...
public static partial class FoMVC
{
    static readonly FormPlugClass s_FormPlug = new FormPlugClass();
    public static FormPlugClass FormPlug { get { return s_FormPlug; } }
}

namespace T4MVC
{
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class FormPlugClass
    {
        public readonly string Name = "FormPlug";
        public FormPlugin.Areas.FormPlug.Controllers.OrderFormController OrderForm = new FormPlugin.Areas.FormPlug.Controllers.T4MVC_OrderFormController();
        public FormPlugin.Areas.FormPlug.Controllers.WidgetController Widget = new FormPlugin.Areas.FormPlug.Controllers.T4MVC_WidgetController();
        public T4MVC.FormPlug.SharedController Shared = new T4MVC.FormPlug.SharedController();
    }
}
