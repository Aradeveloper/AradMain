...
namespace AradCms.Core.ViewModel.User
{
    public class EditUserViewModel
    {
        ...
        [Remote("IsEmailExist", "User", "Administration", ErrorMessage = "این ایمیل قبلا در سیستم ثبت شده است", HttpMethod = "POST", AdditionalFields = "Id")]
        public string Email { get; set; }

        [StringLength(50, ErrorMessage = "کلمه عبور نباید کمتر از 5 حرف و بیتشر از 50 حرف باشد", MinimumLength = 5)]
        [DataType(DataType.Password)]
        [DisplayName("کلمه عبور")]
        [Remote("CheckPassword", "User", "Administration", ErrorMessage = "این کلمه عبور به راحتی قابل تشخیص است", HttpMethod = "POST", AdditionalFields = "Id")]
        public string Password { get; set; }

        [Required(ErrorMessage = "لطفا نام کاربری را وارد کنید")]
        [DisplayName("نام کاربری")]
        [StringLength(450, ErrorMessage = "کلمه عبور نباید کمتر از 5 حرف و بیتشر از 450 حرف باشد", MinimumLength = 5)]
        [Remote("IsUserNameExist", "User", "Administration", ErrorMessage = "این نام کاربری قبلا در سیستم ثبت شده است", HttpMethod = "POST", AdditionalFields = "Id")]
        ...
        [Remote("IsNameForShowExist", "User", "Administration", ErrorMessage = "این نام نمایشی قبلا در سیستم ثبت شده است", HttpMethod = "POST", AdditionalFields = "Id")]
        ...
        [Remote("GooglePlusIdExist", "User", "Administration", ErrorMessage = "این آدرس قبلا در سیستم ثبت شده است", HttpMethod = "POST", AdditionalFields = "Id")]
        public string GooglePlusId { get; set; }

        [DisplayName("آی دی فیسبوک")]
        [MaxLength(20, ErrorMessage = "تعداد کاراکتر های آی دی فیسبوک غیر مجاز است")]
        [Remote("FaceBookIdExist", "User", "Administration", ErrorMessage = "این آدرس قبلا در سیستم ثبت شده است", HttpMethod = "POST", AdditionalFields = "Id")]
