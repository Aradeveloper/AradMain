...
namespace AradCms.Core.ViewModel.User
{
    public class AddUserViewModel
    {
        ...
        [Remote("IsEmailExist", "User", "Administration", ErrorMessage = "این ایمیل قبلا در سیستم ثبت شده است", HttpMethod = "POST")]
        ...
        [Remote("CheckPassword", "User", "Administration", ErrorMessage = "این کلمه عبور به راحتی قابل تشخیص است", HttpMethod = "POST")]
        public string Password { get; set; }

        [Required(ErrorMessage = "لطفا نام کاربری را وارد کنید")]
        [DisplayName("نام کاربری")]
        [StringLength(450, ErrorMessage = "کلمه عبور نباید کمتر از 5 حرف و بیتشر از 450 حرف باشد", MinimumLength = 5)]
        [Remote("IsUserNameExist", "User", "Administration", ErrorMessage = "این نام کاربری قبلا در سیستم ثبت شده است", HttpMethod = "POST")]
        ...
        [Remote("IsNameForShowExist", "User", "Administration", ErrorMessage = "این نام نمایشی قبلا در سیستم ثبت شده است", HttpMethod = "POST")]
        ...
        [Remote("GooglePlusIdExist", "User", "Administration", ErrorMessage = "این آی دی قبلا در سیستم ثبت شده است", HttpMethod = "POST")]
        public string GooglePlusId { get; set; }

        [DisplayName("آی دی فیسبوک")]
        [StringLength(50, ErrorMessage = " آی دی نباید  بیتشر از 50 حرف باشد")]
        [Remote("FaceBookIdExist", "User", "Administration", ErrorMessage = "این آی دی قبلا در سیستم ثبت شده است", HttpMethod = "POST")]
