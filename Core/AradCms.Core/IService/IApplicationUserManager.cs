...
namespace AradCms.Core.IService
{
    public interface IApplicationUserManager : IDisposable
    {
        ...
        /// <param name="userId"/>
        /// <returns/>
        Task<string> GetAccessFailedCountAsync(string userId);
        ...
        IList<ApplicationUser> GetUsersWithRoleIds(params string[] ids);
        ...
        Task<EditUserViewModel> GetUserByRolesAsync(string id);
        ...
        Task<bool> LogicalRemove(string id);

        bool CheckUserNameExist(string userName, string id);

        bool CheckEmailExist(string email, string id);

        bool CheckNameForShowExist(string nameForShow, string id);

        string GetNameForShow(string id);

        bool CheckGooglePlusIdExist(string googlePlusId, string id);

        bool CheckFacebookIdExist(string faceBookId, string id);

        bool CheckPhoneNumberExist(string phoneNumber, string id);

        Task<string> CreateAsync(RegisterViewModel viewModel);

        Task<string> CustomValidatePasswordAsync(string pass);

        bool CheckIsUserBanned(string id);

        Task AddUser(AddUserViewModel viewModel);

        IUserEmailStore<ApplicationUser, string> GetEmailStore();

        IList<string> GetUserPermissions(string userId);

        bool IsEmailConfirmedByUserNameAsync(string userName);

        void EditSecurityStamp(string userId);
        ...
        bool IsModifiedRolesOrPermissions(string userId);

        void SetFalseModifyRolesOrPermissions(string userId);
